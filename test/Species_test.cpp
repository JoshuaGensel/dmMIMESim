...
class SpeciesTest : public testing::Test
{
  protected:
    ...
    {
        params =
            new constants::Constants(50, 2, 12000, 0.01, 0.001, 0.5, 0.75, 0, std::filesystem::temp_directory_path());
...
TEST_F(SpeciesTest, SpecIdxToMutPos)
{
    constants::Constants* small_params =
        new constants::Constants(10, 2, 12000, 0.01, 0.001, 0.5, 0.75, 0, std::filesystem::temp_directory_path());
...
TEST_F(SpeciesTest, DrawSpeciesId_big)
{
    ...
    constants::Constants* big_params =
        new constants::Constants(100, 2, 1200000, 0.01, 0.001, 0.5, 0.3, 0, std::filesystem::temp_directory_path());
